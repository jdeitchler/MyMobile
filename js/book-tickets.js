...
MyAgDataMobile.bookTickets = (function () {
    ...
    function purchaseTickets() {
        ...
        var serviceOptions = {
            url: MyAgDataMobile.configuration.purchaseTicketsUrl,
            data: {
    ...
    function closeModalView() {       
        ...
        MyAgDataMobile.main.getKendoApplication().navigate('#mt-home-main-view');
    }
